...
export const fallbackSiteSettings: SiteSettings = {
  ...
  footer_unit_name: "LIÊN ĐỘI THCS TRẦN QUANG KHẢI",
  footer_slogan: "Thiếu nhi Trần Quang Khải - Chăm ngoan, học tốt, tiếp bước cha anh.",
  phone_2: "Hotline BGH: 0903 123 456",
  footer_nav_title: "Danh mục chính",
  footer_feedback_title: 'Hộp thư "Điều em muốn nói"',
  footer_feedback_desc: 'Nơi học sinh gửi gắm tâm tư, nguyện vọng, góp ý hoặc nhờ sự hỗ trợ từ Thầy Cô Tổng phụ trách và Ban Giám Hiệu.',
  footer_text: "© 2026 Liên đội THCS Trần Quang Khải. Tất cả quyền được bảo lưu.",
